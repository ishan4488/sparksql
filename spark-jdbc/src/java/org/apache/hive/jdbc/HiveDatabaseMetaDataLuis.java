 ...
 *
 */
public class HiveDatabaseMetaDataLuis implements DatabaseMetaData {
  //public static final Log LOG = LogFactory.getLog(HiveDatabaseMetaData.class.getName()); //LM
   ...
   *
   */
  public HiveDatabaseMetaDataLuis(HiveConnection connection, TCLIService.Iface client,
                                  TSessionHandle sessHandle, Log LOG) {
    this.connection = connection;
    this.client = client;
    this.sessHandle = sessHandle;

    System.out.println("[Luis System.out] 2. HiveDatabaseMetaData Constructor");
  }
  ...
  public ResultSet getCatalogs() throws SQLException {
    ...
    System.out.println("[Luis System.out] HiveDatabaseMetaData getCatalogs");

    try (Statement stmt = new HiveStatement(this.connection, this.client, this.sessHandle);
  ...
  public ResultSet getColumns(String catalog, String schemaPattern,
      String tableNamePattern, String columnNamePattern) throws SQLException {
    System.out.println("[Luis System.out] HiveDatabaseMetaData getColumns " + catalog);
  ...
  public Connection getConnection() throws SQLException {
    System.out.println("[Luis System.out] HiveDatabaseMetaData getConnection ");
  ...
  public ResultSet getSchemas() throws SQLException {
    System.out.println("[LUIS] 4. HiveDatabaseMetaData getSchemas() ");
    ...
    try {
        ...
        //  throw new SQLException("Failed to get schema information");
        //}
      //ResultSet result = res.getString(1);
      //System.out.println("[LUIS] Result is " + result);
  ...
  public ResultSet getTables(String catalog, String schemaPattern,
    ...
    System.out.println("[Luis System.out] HiveDatabaseMetaData getTables =" + catalog);
  ...
  public static void main(String[] args) throws SQLException {
    HiveDatabaseMetaDataLuis meta = new HiveDatabaseMetaDataLuis(null, null, null, null);
