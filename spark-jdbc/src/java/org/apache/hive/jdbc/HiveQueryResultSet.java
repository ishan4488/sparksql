...
public class HiveQueryResultSet extends HiveBaseResultSet {
  ...
  public static class Builder {
    ...
    public Builder setRetrieveSchema(boolean retrieveSchema) {
      this.retrieveSchema = retrieveSchema;
      return this;
    }
  ...
  public void addColumn(String name, String type)  {
    // Ugly hack to add Columns so that Pentaho and other BI tools can get metadata
    // The JDBC Standards specifies what Columns must be returned. This allows
    // us to add the Columns
    columnNames.add(name);
    normalizedColumnNames.add(name.toLowerCase());
