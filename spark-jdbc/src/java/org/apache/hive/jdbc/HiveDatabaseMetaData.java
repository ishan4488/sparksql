...
public class HiveDatabaseMetaData implements DatabaseMetaData {
  ...
  public ResultSet getCatalogs() throws SQLException {
    ...
    */
    ...
    // In Hive/Spark Catalog and Databases are the same. Use
    ...
    result.updateString("databaseName", "TABLE_SCHEM");
    return result;
  ...
  public ResultSet getColumns(String catalog, String schemaPattern,
    ...
    */
    ...
    result = (HiveQueryResultSet)  statement.executeQuery(sql);
    result.updateString("col_name", "COLUMN_NAME");
    result.updateString("data_type", "TYPE_NAME");
    result.updateString("comment", "REMARKS");
    return result;
  }
  ...
  public ResultSet getTables(String catalog, String schemaPattern,
    ...
    */
    ...
    // HiveQueryResultSet result = (HiveQueryResultSet) execute("show tables");
    result.updateString("database", "TABLE_CAT");
    result.updateString("tableName", "TABLE_NAME");
    result.updateString("isTemporary", "TABLE_REMARKS");

    result.addColumn("TABLE_SCHEM", "NULL");
